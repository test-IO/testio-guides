...
{% screenshot src="/assets/jira_cloud/create_exploratory_test/step2_1.png" /%}
...
{% screenshot src="/assets/jira_cloud/test_types.gif" caption="Exploratory Test type Details" /%}
...
{% screenshot src="/assets/jira_cloud/create_exploratory_test/step2_2.gif" caption="Create New Exploratory Test via Template" /%}
...
{% screenshot src="/assets/jira_cloud/create_exploratory_test/step4_2.png" caption="Create New Environment" /%}

{% screenshot src="/assets/jira_cloud/create_exploratory_test/step4_3.png" caption="Create New Environment with Access Claims" /%}
...
{% screenshot src="/assets/jira_cloud/create_exploratory_test/step5_2.png" caption="Features in Test" /%}
...
{% screenshot src="/assets/jira_cloud/create_exploratory_test/step5_3.png" caption="Add new Feature" /%}
...
{% screenshot src="/assets/jira_cloud/create_exploratory_test/step7_1.png" caption="Default Devices" /%}

{% screenshot src="/assets/jira_cloud/create_exploratory_test/step7_2.png" caption="Custom Devices" /%}

{% screenshot src="/assets/jira_cloud/create_exploratory_test/step7_3.png" caption="Add new Device" /%}

**Step 8: Select Test Date and Start Time** {% .title-small %}
...
**Step 9: Review and Create test** {% .title-small %}

Review the form and click "Create" to submit the test.
...
href="/docs/jira_cloud/user_stories"
