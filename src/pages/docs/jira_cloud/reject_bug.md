...
The bug is rejected in both Jira Add-On and Test IO, **removed from the Bug Triage/ Open bugs list**, and later **can be found in the Jira Add-On's "All Bugs" list** with the rejection reason included in the comments.
