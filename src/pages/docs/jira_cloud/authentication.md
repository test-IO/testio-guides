...
description: Learn how to authenticate for the Jira Cloud Add-On.
---

Follow these steps to configure the Authentication for Jira Cloud Add-On:
...
3. **Save Changes**: Click **"Save"** to complete the authentication.
   {% screenshot src="/assets/jira_cloud/auth/2.png" caption="Authentication page in Jira Cloud Add-On" /%}
