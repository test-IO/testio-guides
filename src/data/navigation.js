const navigation = [
  ...
  },
  {
    ...
    links: [
      ...
      { title: "Custom field in Configuration", href: "/docs/jira_cloud/custom_field_in_config" },
      { title: "Demo Bug in Configuration", href: "/docs/jira_cloud/demo_bug_in_config" },
      {
        title: "Advanced Integration in Configuration",
        href: "/docs/jira_cloud/advanced_integration",
      },
      { title: "Test IO Bugs: Bug Triage", href: "/docs/jira_cloud/test_io_bugs_triage" },
      { title: "Bug Triage: Accepting Test IO Bug", href: "/docs/jira_cloud/accepting_bug" },
      { title: "Bug Triage: Rejection of Test IO Bug", href: "/docs/jira_cloud/rejection_of_bug" },
      {
      ...
      { title: "Exploratory Tests", href: "/docs/jira_cloud/exploratory_tests" },
      { title: "Exploratory Test types", href: "/docs/jira_cloud/exploratory_test_types" },
      { title: "Bug Severities", href: "/docs/jira_cloud/bug_severities" },
      { title: "Create New Exploratory Test", href: "/docs/jira_cloud/create_exploratory_test" },
  ...
  },
  {
    ...
    links: [
      { title: "QA Service for Jira: About us", href: "/docs/jira_server/qa_jira_about" },
      { title: "Installation", href: "/docs/jira_server/installation" },
      { title: "Connection", href: "/docs/jira_server/connection" },
      { title: "Configuration", href: "/docs/jira_server/configuration" },
      { title: "Custom field in Configuration", href: "/docs/jira_server/custom_field_in_config" },
      { title: "Demo Bug in Configuration", href: "/docs/jira_server/demo_bug_in_config" },
      ...
      { title: "Bug Triage: Accept a Test IO Bug", href: "/docs/jira_server/accept_bug" },
      { title: "Bug Triage: Reject a Test IO Bug", href: "/docs/jira_server/reject_bug" },
      {
        title: "Bug Triage: Changing Severity of Test IO Bug",
      ...
      { title: "Create New Exploratory Test", href: "/docs/jira_server/create_exploratory_test" },
